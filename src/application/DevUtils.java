...
public class DevUtils {
    ...
    public static List<Component> createTestComponents() {
        ...
        // 70KV breakers
        Wire w3 = new Wire(canvasPos(6,-8), false);
        Wire w5 = new Wire(canvasPos(3,-8), false);
        Wire w7 = new Wire(canvasPos(0,-8), false);
        Wire w8 = new Wire(canvasPos(-3,-8), false);
        Wire w9 = new Wire(canvasPos(-6,-8), false);
        ...
        Breaker dd9 = new Breaker("DD9",
                canvasPos(-6, -4),
                Voltage.KV12, false, null);
        Wire bbus = new Wire(canvasPos(-6, -4), canvasPos(6, -4), false);
        ...
        Wire dd1mw = new Wire(canvasPos(0,0), false);
        ...
        Wire xw = new Wire(canvasPos(0, 3), canvasPos(3, 3), false);
        ...
        xw.connect(dd101);
        Wire dd101w = new Wire(canvasPos(0, 6), false);
        dd101.connectInWire(dd101w);
        dd101w.connect(dd101);

        // Side route switch
        Switch dd105 = new Switch("DD-105", canvasPos(3, 9), false);
        Wire dd105bw = new Wire(canvasPos(3, 6), canvasPos(3, 3), false);
        dd105bw.connect(xw);
        xw.connect(dd105bw);
        dd105bw.connect(dd105);
        dd105.connectOutWire(dd105bw);
        Wire dd105aw = new Wire(canvasPos(3, 12), canvasPos(3, 9), false);
        ...
        dd101w.connect(dd1);
        Wire dd1w = new Wire(canvasPos(0, 9), false);
        ...
        dd1w.connect(dd103);
        Wire nrw = new Wire(canvasPos(0, 12), canvasPos(3, 12), false);
        ...
        // test bridge wires
        Wire w1 = new Wire(canvasPos(10, 10), canvasPos(20, 10), false);

        Wire w2 = new Wire(canvasPos(15, 15), canvasPos(15, 5), false);
